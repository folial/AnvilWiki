...
export const NAVIGATION_CONFIG: NavigationItem[] = [
  ...
  { key: 'houses', path: '/houses', icon: 'lucide:folder', isContentType: true, order: 2 },
  { key: 'buildings', path: '/buildings', icon: 'lucide:folder', isContentType: true, order: 3 },
  { key: 'crew', path: '/crew', icon: 'lucide:folder', isContentType: true, order: 4 },
];
